...
function CreateStep1() {
  ...
  return (
    <div>
      ...
      <FlexBox
        input1Col1={<CalendarInput label="Flight Date" />}
        input2Col1={<InputMask label="From " />}
        input3Col1={""}
        input1Col2={<InputMask label="Flight Number" />}
        input2Col2={<InputMask label="To" />}
        input3Col2={""}
      />
